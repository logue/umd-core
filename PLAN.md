...
- **動画**: `.mp4`, `.webm`, `.ogv` 等 → `<video>`タグ（🎬アイコン付きダウンロードフォールバック）
- **音声**: `.mp3`, `.wav`, `.ogg` 等 → `<audio>`タグ（🎵アイコン付きダウンロードフォールバック）
- **画像**: `.jpg`, `.png`, `.webp`, `.avif` 等 → `<picture>`タグ（`<img>`フォールバック）

**ダウンロード可能ファイル**:

- **アーカイブ**: `.zip`, `.tar`, `.gz`, `.7z`, `.rar` 等 → 📄ダウンロードリンク
- **ドキュメント**: `.pdf`, `.doc`, `.docx`, `.xls`, `.ppt` 等 → 📄ダウンロードリンク
- **テキスト**: `.txt`, `.csv`, `.json`, `.xml` 等 → 📄ダウンロードリンク
- **実行ファイル**: `.exe`, `.dmg`, `.deb`, `.rpm` 等 → 📄ダウンロードリンク

**特徴**:

- ブラウザ非対応時もダウンロードリンクで代替表示
- メディアタイプ別絵文字アイコン（TwiEmoji推奨）
- `download`属性でブラウザにダウンロード動作を指示
- CSS/JSカスタマイズ用のclass属性付与

**実装日**: 2026/02/10
**詳細**: [docs/implemented-features.md#メディアファイル自動検出](docs/implemented-features.md#メディアファイル自動検出)
...
- ✅ **パス基準URL設定** (2026年2月18日実装): パーサーオプションでベースURLを指定
...
- Step 5: Markdown拡張機能（2026年2月16日完了）
- 成果: CommonMark 75%+ 準拠、GFM互換性確保、テーブル拡張、打ち消し線、参照スタイルリンク対応

### Phase 4: 高度なUMD機能 ✅ 完了

- Step 6: UMD複雑機能（2026年2月18日完了）
- 成果: リスト内ブロック要素、タスクリスト拡張、カスタムリンク属性、パス基準URL設定

### Phase 5: HTML生成・テスト整備 🚧 今後

- Step 7: テスト・最適化・HTML生成
- 目標期間: 1-2週間
- 成果: プロダクション品質、包括的テストカバレッジ
...
**最終更新**: 2026年2月18日  
**ライセンス**: MIT License  
**次のステップ**: Phase 5（HTML生成・テスト整備）の Step 7 実装
...
- Step 4: 競合解決
- 実績: 2026年2月中旬完了
- 成果: CommonMark 75%+達成の基礎構築

### Phase 3: 拡張機能・準拠性 ✅ 完了

- Step 5: Markdown拡張機能
- 実績: 2026年2月16日完了
- 成果: CommonMark 75%+ 準拠、テーブル拡張、GFM互換性

### Phase 4: 高度なUMD機能 ✅ 完了

- Step 6: UMD複雑機能（リスト内ブロック、タスクリスト拡張、カスタムリンク属性、パス基準URL）
- 実績: 2026年2月18日完了
- 成果: 完全なレガシー構文互換性、高度な機能統合

### Phase 5: HTML生成・テスト整備 🚧 今後

- Step 7: テスト・最適化・ドキュメント整備
- 目標期間: 1-2週間
- 成果: プロダクション品質、包括的テストカバレッジ
